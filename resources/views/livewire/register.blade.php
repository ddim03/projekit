<section class="flex flex-col items-center justify-center px-4 bg-gray-50 h-dvh sm:px-0">
    <div class="max-w-2xl mt-20 text-center sm:mt-0">
        <h2 class="text-2xl font-bold leading-tight text-black sm:text-2xl">Create free account</h2>
    </div>
    <div class="relative w-full mt-8 sm:w-1/3 md:mt-5">
        <div class="overflow-hidden bg-white rounded-md shadow-md">
            <div class="px-4 py-6 sm:px-8 sm:py-7">
                <form wire:submit.prevent="registerUser">
                    ...
                    <button type="submit"
                        class="inline-flex items-center justify-center w-full px-4 py-2.5 mt-5 text-sm font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">
                        <div wire:loading>
